...
const API_URL = "/mock-merchant-charges.json";
...
export default function MerchantCharges() {
  const [data, setData] = useState<ChargeRule[] | null>(null);
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          <h1 className="font-display text-2xl font-bold text-ink-900 dark:text-white">Transaction Charges</h1>
      ...
      {!loading && error && (
        <div className="glass-card p-6 border border-rose-500/20 bg-rose-500/5 text-center max-w-xl mx-auto space-y-4">
          ...
          <p className="text-xs text-ink-500 dark:text-ink-400">
            Failed to fetch platform MDR settings. Check your API URL placeholder or try again.
          </p>
          <button
            onClick={loadCharges}
